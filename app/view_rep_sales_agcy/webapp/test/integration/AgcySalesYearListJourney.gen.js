...
sap.ui.define([
    ...
    function journey() {
        QUnit.module("AgcySalesYearListListReport journey");

        opaTest("Start application", function (Given, When, Then) {
            Given.iStartMyApp();

            Then.onTheAgcySalesYearListGenerated.iSeeThisPage();
        });
        ...
        //     When.onTheAgcySalesYearListGenerated.onFilterBar().iChangeSearchField("Search Term");
